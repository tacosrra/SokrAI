...
describe('resources pilot viability domain rules', () => {
  ...
  it('resolves remaining active resources pilot viability gaps when completion criteria are met', () => {
    const reviewGap: AlphaGap = {
      ...
      absence: {
        ...
        reason: 'The phase can close with this operational uncertainty documented.',
      },
    };

    expect(classifyResourcesPilotViabilityGapStatuses([reviewGap], completeState, 'turn-1')).toEqual([
      {
